...
@section('content')
        ...
        <div class="flex w-full flex-col">
            <div class="py-4 md:pb-7 md:pt-12">
                <div class="mb-2 flex items-center gap-2">
                    ...
                    <p class="text-base font-bold leading-normal text-gray-800 sm:text-lg md:text-2xl lg:text-4xl">Buat
                        Invoice</p>
                </div>
                    ...
                    <div class="flex flex-col gap-5 w-full">
                        ...
                        <div class="flex flex-row gap-5 w-full">
                            ...
                            <div class="w-1/3 flex flex-col gap-2">
                                ...
                                <input name="customer_agency" type="text"
                                    class="w-full rounded-lg bg-[#F4F4F4] border-2 border-[#B3B3B3] px-1.5 py-[6.5px] shadow-sm text-sm">
                            </div>
                            <div class="w-1/3 flex flex-col gap-2">
                        ...
                        <div class="flex flex-row justify-end gap-5">
                            ...
                            <button type="button" onclick="openConfirmModal()"
                                class="rounded px-10 py-2 text-white bg-primary flex gap-2 items-center">Buat
                                Invoice</button>
                        </div>
                    </div>
                </form>
    ...
    <div id="confirmModal" class="fixed inset-0 z-50 flex hidden items-center justify-center bg-black/40">
        <div class="relative w-[360px] md:w-[560px] rounded-[20px] bg-white p-6 text-center font-plusJakartaSans shadow-lg"
            ...
            <!-- Title -->
            <h2 class="mt-4 text-2xl font-bold text-stone-900">Buat Invoice?</h2>
            ...
            <div class="mt-6 flex justify-center gap-3">
                <button type="button" onclick="closeConfirmModal()"
                    class="rounded-lg border border-stone-300 px-6 py-2 text-stone-700">Kembali</a>
