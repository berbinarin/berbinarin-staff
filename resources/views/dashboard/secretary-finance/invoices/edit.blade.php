    ...
    <section class="flex w-full">
        <div class="flex w-full flex-col">
            <div class="py-4 md:pb-7 md:pt-12">
                ...
                <p class="w-full text-disabled">Perbarui data <span class="italic">invoice</span>. Dokumen akan digenerate ulang secara otomatis dalam format PDF.</p>
            </div>
                    ...
                    <div class="flex flex-col gap-5 w-full">
                        ...
                        <div>
                            ...
                            <input type="text" id="invoice_number" name="invoice_number"
                                ...
                                placeholder="011 / INV / BERBINAR / VII / 2025" value="011/INV/BERBINAR/VII/2026" required>
                        </div>
                        ...
                        <div class="flex flex-row gap-5 w-full">
                            <div class="w-1/3 flex flex-col gap-2">
                                ...
                                <input type="text" class="w-full rounded-lg bg-[#F4F4F4] border-2 border-[#B3B3B3] px-1.5 py-[6.5px] shadow-sm text-sm" value="Finance Manager">
                            </div>
                            <div class="w-1/3 flex flex-col gap-2">
                                <label for="agency">Instansi</label>
                                <input type="text" class="w-full rounded-lg bg-[#F4F4F4] border-2 border-[#B3B3B3] px-1.5 py-[6.5px] shadow-sm text-sm" value="PT Maju Jaya">
                            </div>
                            <div class="w-1/3 flex flex-col gap-2">
                                <label for="invoice_date">Tanggal Invoice</label>
                                <input type="date" class="w-full rounded-lg bg-[#F4F4F4] border-2 border-[#B3B3B3] px-1.5 py-[6.5px] shadow-sm text-sm" value="01-01-2026">
                            </div>
                        </div>
                                    ...
                                    <tbody id="invoice-items">
                                        <tr>
                                            ...
                                            <td class="border-b-2 border-gray-300 px-2 py-3">
                                                ...
                                                value="Produksi Dashboard Secfin">
                                            </td>
                                            <td class="border-b-2 border-gray-300 px-2 py-3">
                        ...
                        <div class="flex flex-row justify-end gap-5">
                            ...
                            <button type="button" onclick="openConfirmModal()" class="rounded px-10 py-2 text-white bg-primary flex gap-2 items-center">Simpan Perubahan</button>
                        </div>
                    </div>
