                                ...
                                <tr class="hover:bg-gray-50 transition text-md lg:text-base">
                                    ...
                                    <td class="flex justify-center gap-2">
                                        ...
                                        <a href="{{ route('dashboard.peer-staff.edit', $item->id) }}" class="p-2 bg-yellow-500 hover:bg-yellow-600 rounded"><i
                                            ...
                                            <button onclick="openDeleteModal({{ $item->id }}, '{{ e($item->name) }}')" class="p-2 bg-red-500 hover:bg-red-600 rounded focus:outline-none"><i class="bx bx-trash-alt text-white"></i></button>
