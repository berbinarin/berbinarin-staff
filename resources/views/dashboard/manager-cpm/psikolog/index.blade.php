        ...
        <div class="flex flex-col w-full">
            <div class="py-4 md:pt-12 md:pb-7 px-4 md:px-8 xl:px-10">
                <div class="-ml-10">
                    ...
                    <a href="{{ route('dashboard.psikolog-staff.create') }}" type="button"
                            ...
                            @forelse ($PsikologData as $key => $item)
                                <tr class="hover:bg-gray-50 transition text-md lg:text-base">
                                    ...
                                    <td class="flex justify-center gap-2">
                                        <a href="{{ route('dashboard.psikolog-staff.show', $item->id) }}" class="p-2 bg-blue-500 hover:bg-blue-600 rounded"><i
...
@section('script')
    <script>
        ...
        function openDeleteModal(classId) {
            deleteForm.action = `/dashboard/psikolog-staff/${classId}`;
