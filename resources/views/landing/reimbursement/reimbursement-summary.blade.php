    ...
    <div
        ...
        {{-- <div class="flex justify-end">
            <div class="flex cursor-pointer items-center space-x-1" id="openModal">
                <img src="{{ asset('assets/images/landing/product/asset-konseling/vector/sk-vector.webp') }}" alt="Syarat & Ketentuan"
                    class="hr-3 w-auto" />
            ...
            <div
                ...
                <div class="mb-6">
                    <div class="flex items-start gap-2">
                        <img src="{{ asset('assets/images/landing/product/asset-konseling/vector/payment.webp') }}" alt="Pembayaran"
                ...
                <div class="mb-6">
                    <div class="flex items-start gap-2">
                        <img src="{{ asset('assets/images/landing/product/asset-konseling/vector/chat.webp') }}"
                ...
                <div class="mb-6">
                    <div class="flex items-start gap-2">
                        <img src="{{ asset('assets/images/landing/product/asset-konseling/vector/cancel.webp') }}"
        ...
        <div class="flex flex-col space-y-4">
            ...
            <p class="text-gradient text-center text-base font-medium md:text-2xl drop-shadow-lg">
                ...
                reimbursement melalui Secretary and Finance Manager.
                <br>
                <br>
                <a href="https://wa.me/6281775237363"><span class="font-bold text-gradient">081775237363 (Stephanie)</span></a>
            </p>
        </div>
